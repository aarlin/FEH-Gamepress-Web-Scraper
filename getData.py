...
heroArray = ['abel', 'adrift-camilla', 'adrift-corrin-f', 'adrift-corrin-m', 'alfonse', 'alm', 'amelia', 'anna', 'arden', 'ares', 'arthur', 'arvis', 'athena', 'aversa', 'ayra', 'azama', 'azura', 'azura-young'
	...
	'legendary-azura', 'legendary-eirika', 'legendary-ephraim', 'legendary-hector', 'legendary-ike', 'legendary-lucina', 'legendary-lyn', 'legendary-math', 'legendary-robin-f', 'legendary-ryoma', 'legendary-tiki-young',
	...
	'Quan',
	'raigh', 'raven', 'rebecca', 'reinhardt', 'reinhardt-wt', 'reyson', 'rhajat', 'robin-f', 'robin-m', 'roderick', 'roy', 'roy-la', 'ryoma', 
