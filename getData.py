...
heroArray = ['abel', 'adrift-camilla', 'adrift-corrin-f', 'adrift-corrin-m', 'alfonse', 'alm', 'amelia', 'anna', 'arden', 'ares', 'arthur', 'arvis', 'athena', 'aversa', 'ayra', 'azama', 'azura', 'azura-young'
	...
	'legion', 'leif', 'lene', 'leo', 'leon', 'lewyn', 'libra', 'lilina', 'lilina-la', 'linde', 'linus', 'lissa', 'lloyd', 'loki', 'lonqu', 'lucina', 'lucius', 'lugh', 'lukas', 'luke', 'lute', 'lyn', 'lyn-la', 
	'lyon', 
	...
	'quan',
	'raigh', 'raven', 'rebecca', 'reinhardt', 'reinhardt-wt', 'reyson', 'rhajat', 'robin-f', 'robin-m', 'roderick', 'roy', 'roy-la', 'rutger', 'ryoma', 
	...
	'sonya', 'sophia', 'soren', 'sothe', 'spring-alfonse', 'spring-bruno', 'spring-camilla', 'spring-catria', 'spring-chrom', 'spring-kagero', 'spring-loki', 'spring-lucina', 'spring-palla', 'spring-marisa', 'spring-sharena', 'spring-veronica', 'spring-xander', 'stahl', 
